...
/* Clock outputs (values are in Hz): */
#define BOARD_BOOTCLOCKRUN_400M_ADC_ALT_CLK           40000000UL     /* Clock consumers of ADC_ALT_CLK output : N/A */
...
#define BOARD_BOOTCLOCKRUN_400M_CORE_CLK_ROOT         396000000UL    /* Clock consumers of CORE_CLK_ROOT output : ARM, FLEXSPI */
...
#define BOARD_BOOTCLOCKRUN_400M_IPG_CLK_ROOT          99000000UL     /* Clock consumers of IPG_CLK_ROOT output : ADC1, ADC_ETC, AIPSTZ1, AIPSTZ2, AOI, ARM, CCM, CSU, DCDC, DCP, DMA0, DMAMUX, EWM, FLEXIO1, FLEXRAM, FLEXSPI, GPC, GPIO1, GPIO2, GPIO5, IOMUXC, KPP, LPI2C1, LPI2C2, LPSPI1, LPSPI2, LPUART1, LPUART2, LPUART3, LPUART4, OCOTP, PWM1, RTWDOG, SAI1, SAI3, SNVS, SPDIF, SRC, TEMPMON, TRNG, USB, WDOG1, WDOG2, XBARA */
#define BOARD_BOOTCLOCKRUN_400M_LPI2C_CLK_ROOT        60000000UL     /* Clock consumers of LPI2C_CLK_ROOT output : LPI2C1, LPI2C2 */
#define BOARD_BOOTCLOCKRUN_400M_LPSPI_CLK_ROOT        105600000UL    /* Clock consumers of LPSPI_CLK_ROOT output : LPSPI1, LPSPI2 */
...
#define BOARD_BOOTCLOCKRUN_400M_UART_CLK_ROOT         80000000UL     /* Clock consumers of UART_CLK_ROOT output : LPUART1, LPUART2, LPUART3, LPUART4 */
#define BOARD_BOOTCLOCKRUN_400M_USBPHY_CLK            0UL            /* Clock consumers of USBPHY_CLK output : TEMPMON, USB */
